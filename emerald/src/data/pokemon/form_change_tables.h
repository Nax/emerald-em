...
#if defined(RANDO)
    {FORM_CHANGE_ITEM_USE,    SPECIES_SHAYMIN_SKY,  ITEM_GRACIDEA, 0, STATUS1_FREEZE | STATUS1_FROSTBITE},
...
static const struct FormChange sHoopaFormChangeTable[] = {
    ...
    {FORM_CHANGE_ITEM_USE, SPECIES_HOOPA_CONFINED,  ITEM_PRISON_BOTTLE, SPECIES_HOOPA_UNBOUND},
#else
    {FORM_CHANGE_ITEM_USE,    SPECIES_HOOPA_UNBOUND, ITEM_PRISON_BOTTLE, SPECIES_HOOPA_CONFINED},
