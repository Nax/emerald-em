...
#define MOVES_COUNT_GEN1 (MOVE_STRUGGLE + 1)
...
#define MOVES_COUNT_GEN2 (MOVE_BEAT_UP + 1)
...
/* Gen 7 moves. */
/* Z-moves, some of which takes two slots (I assume the game has physical/special variants internally) */
...
/* The Teal Mask Moves */
#define MOVE_BLOOD_MOON         901
#define MOVE_MATCHA_GOTCHA      902
#define MOVE_SYRUP_BOMB         903
#define MOVE_IVY_CUDGEL         904

/* The Indigo Disk Moves */
#define MOVE_ELECTRO_SHOT       905
#define MOVE_TERA_STARSTORM     906
#define MOVE_FICKLE_BEAM        907
#define MOVE_BURNING_BULWARK    908
#define MOVE_THUNDERCLAP        909
#define MOVE_MIGHTY_CLEAVE      910
#define MOVE_TACHYON_CUTTER     911
#define MOVE_HARD_PRESS         912
#define MOVE_DRAGON_CHEER       913
#define MOVE_ALLURING_VOICE     914
#define MOVE_TEMPER_FLARE       915
#define MOVE_SUPERCELL_SLAM     916
#define MOVE_PSYCHIC_NOISE      917
#define MOVE_UPPER_HAND         918
#define MOVE_MALIGNANT_CHAIN    919

#define MOVES_COUNT_GEN9    (MOVE_MALIGNANT_CHAIN + 1)

#define MOVES_COUNT         MOVES_COUNT_GEN9

/* Gigantamax Moves */
#define MOVE_G_MAX_VINE_LASH    (MOVES_COUNT +  0)
#define MOVE_G_MAX_WILDFIRE     (MOVES_COUNT +  1)
#define MOVE_G_MAX_CANNONADE    (MOVES_COUNT +  2)
#define MOVE_G_MAX_BEFUDDLE     (MOVES_COUNT +  3)
#define MOVE_G_MAX_VOLT_CRASH   (MOVES_COUNT +  4)
#define MOVE_G_MAX_GOLD_RUSH    (MOVES_COUNT +  5)
#define MOVE_G_MAX_CHI_STRIKE   (MOVES_COUNT +  6)
#define MOVE_G_MAX_TERROR       (MOVES_COUNT +  7)
#define MOVE_G_MAX_FOAM_BURST   (MOVES_COUNT +  8)
#define MOVE_G_MAX_RESONANCE    (MOVES_COUNT +  9)
#define MOVE_G_MAX_CUDDLE       (MOVES_COUNT + 10)
#define MOVE_G_MAX_REPLENISH    (MOVES_COUNT + 11)
#define MOVE_G_MAX_MALODOR      (MOVES_COUNT + 12)
#define MOVE_G_MAX_MELTDOWN     (MOVES_COUNT + 13)
#define MOVE_G_MAX_DRUM_SOLO    (MOVES_COUNT + 14)
#define MOVE_G_MAX_FIREBALL     (MOVES_COUNT + 15)
#define MOVE_G_MAX_HYDROSNIPE   (MOVES_COUNT + 16)
#define MOVE_G_MAX_WIND_RAGE    (MOVES_COUNT + 17)
#define MOVE_G_MAX_GRAVITAS     (MOVES_COUNT + 18)
#define MOVE_G_MAX_STONESURGE   (MOVES_COUNT + 19)
#define MOVE_G_MAX_VOLCALITH    (MOVES_COUNT + 20)
#define MOVE_G_MAX_TARTNESS     (MOVES_COUNT + 21)
#define MOVE_G_MAX_SWEETNESS    (MOVES_COUNT + 22)
#define MOVE_G_MAX_SANDBLAST    (MOVES_COUNT + 23)
#define MOVE_G_MAX_STUN_SHOCK   (MOVES_COUNT + 24)
#define MOVE_G_MAX_CENTIFERNO   (MOVES_COUNT + 25)
#define MOVE_G_MAX_SMITE        (MOVES_COUNT + 26)
#define MOVE_G_MAX_SNOOZE       (MOVES_COUNT + 27)
#define MOVE_G_MAX_FINALE       (MOVES_COUNT + 28)
#define MOVE_G_MAX_STEELSURGE   (MOVES_COUNT + 29)
#define MOVE_G_MAX_DEPLETION    (MOVES_COUNT + 30)
#define MOVE_G_MAX_ONE_BLOW     (MOVES_COUNT + 31)
#define MOVE_G_MAX_RAPID_FLOW   (MOVES_COUNT + 32)

#define MOVES_COUNT_ALL         (MOVE_G_MAX_RAPID_FLOW + 1)

// Used for checks for moves affected by Disable, Mimic, etc.
#define MOVE_UNAVAILABLE 0xFFFF

#define IS_Z_MOVE(x)    (((x) >= MOVE_BREAKNECK_BLITZ && (x) <= MOVE_CATASTROPIKA) \
                        || ((x) >= MOVE_SINISTER_ARROW_RAID && (x) <= MOVE_GENESIS_SUPERNOVA) \
                        || ((x) == MOVE_10000000_VOLT_THUNDERBOLT) \
                        || ((x) >= MOVE_LIGHT_THAT_BURNS_THE_SKY && (x) <= MOVE_CLANGOROUS_SOULBLAZE))

#define IS_DMAX_MOVE(x) ((x) == MOVE_MAX_GUARD || ((x) >= MOVE_MAX_FLARE && (x) <= MOVE_MAX_STEELSPIKE))
#define IS_GMAX_MOVE(x) ((x) >= MOVE_G_MAX_VINE_LASH && (x) <= MOVE_G_MAX_RAPID_FLOW)
#define IS_MAX_MOVE(x)  (IS_DMAX_MOVE(x) || IS_GMAX_MOVE(x))
