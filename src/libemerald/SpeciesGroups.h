...
struct SpeciesGroups
{
    ...
    static inline const SpeciesSet Furfrou = {
        SPECIES_FURFROU, SPECIES_FURFROU_HEART, SPECIES_FURFROU_DIAMOND, SPECIES_FURFROU_STAR, SPECIES_FURFROU_PHARAOH,
        SPECIES_FURFROU_KABUKI, SPECIES_FURFROU_LA_REINE, SPECIES_FURFROU_MATRON, SPECIES_FURFROU_DANDY, SPECIES_FURFROU_DEBUTANTE,
    };
